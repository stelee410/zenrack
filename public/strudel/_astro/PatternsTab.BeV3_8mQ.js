import{j as s}from"./jsx-runtime.CLpGMVip.js";import{g as F,u as m,c as C,d as h,e as u,f as c,h as f,j as y}from"./prebake.D72SZ86e.js";import{r as B}from"./index.B9mnsnPE.js";const A=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
.clip(.5)
.piano()
.pianoroll()`,_=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
`,X=Object.freeze(Object.defineProperty({__proto__:null,amensister:U,arpoon:Q,barryHarris:k,bassFuge:M,belldub:L,blippyRhodes:G,caverave:w,chop:K,csoundDemo:V,delay:O,dinofunk:W,echoPiano:R,festivalOfFingers:N,festivalOfFingers3:Y,flatrave:J,giantSteps:x,goodTimes:j,holyflute:z,juxUndTollerei:$,loungeSponge:Z,meltingsubmarine:q,orbit:H,randomBells:T,sampleDemo:I,sampleDrums:D,sml1:_,swimming:A,undergroundPlumber:S,waa2:P,wavyKalimba:E,zeldasRescue:v},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(X).map(([e,a],o)=>[o,{id:o,code:a,collection:"Stock Examples"}]));function b(...e){return e.filter(Boolean).join(" ")}function i({children:e,label:a,labelIsHidden:o,className:t,...l}){return s.jsxs("button",{className:b("hover:opacity-50 text-nowrap w-fit",t),title:a,...l,children:[o!==!0&&a,e]})}function ie(e){const{className:a,...o}=e;return s.jsx(i,{...o,className:b("bg-background p-2 max-w-[300px] rounded-md hover:opacity-50",a)})}function ee({label:e,className:a,...o}){return s.jsxs("label",{className:b("inline-flex items-center cursor-pointer",a),children:[s.jsx("input",{...o,className:"sr-only peer"}),s.jsx("span",{className:"inline-flex items-center peer-hover:opacity-50",children:e})]})}function re({className:e,...a}){return s.jsx(ee,{...a,className:e,label:s.jsx("span",{className:"bg-background p-2 max-w-[300px] rounded-md",children:a.label})})}function se({pattern:e}){const a=B.useMemo(()=>F(e.code),[e]);let o=a.title;if(o==null){const l=new Date(e.created_at);isNaN(l)?o="unnamed":o=l.toLocaleDateString()}const t=Array.isArray(a.by)?a.by.join(","):"Anonymous";return s.jsx(s.Fragment,{children:`${e.id}: ${o} by ${t.slice(0,100)}`.slice(0,60)})}function ae({showOutline:e,onClick:a,pattern:o,showHiglight:t}){return s.jsx("a",{className:b("mr-4 hover:opacity-50 cursor-pointer block",e&&"outline outline-1",t&&"bg-selection"),onClick:a,children:s.jsx(se,{pattern:o})})}function oe({patterns:e,activePattern:a,onClick:o,started:t}){const l=h(),p=u(l).id;return s.jsx("div",{className:"",children:Object.values(e).reverse().map(r=>{const n=r.id;return s.jsx(ae,{pattern:r,showHiglight:n===p,showOutline:n===a&&t,onClick:()=>o(n)},n)})})}const d=(e,a,o=!1)=>{e.handleUpdate(a,o)};function ne({context:e}){const a=C(),o=h(),t=u(o),{userPatterns:l,patternFilter:g,patternAutoStart:p}=m(),r=t?.id;return s.jsxs("div",{className:"flex flex-col gap-2 flex-grow overflow-hidden h-full pb-2 ",children:[s.jsxs("div",{className:"pr-4 space-x-4  flex max-w-full overflow-x-auto",children:[s.jsx(i,{label:"new",onClick:()=>{const{data:n}=c.createAndAddToDB();d(e,n)}}),s.jsx(i,{label:"duplicate",onClick:()=>{const{data:n}=c.duplicate(t);d(e,n)}}),s.jsx(i,{label:"delete",onClick:()=>{const{data:n}=c.delete(r);d(e,{...n,collection:c.collection})}}),s.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[s.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,text/x-markdown,application/json",onChange:n=>f(n.target.files)}),"import"]}),s.jsx(i,{label:"export",onClick:y}),s.jsx(i,{label:"delete-all",onClick:()=>{const{data:n}=c.clearAll();d(e,n)}})]}),s.jsx("div",{className:"overflow-auto h-full bg-background p-2 rounded-md",children:s.jsx(oe,{onClick:n=>{d(e,{...l[n],collection:c.collection},p),e.started&&a===n&&e.handleEvaluate()},patterns:l,started:e.started,activePattern:a,viewingPatternID:r})})]})}function de({context:e}){return m(),s.jsx("div",{className:"px-4 w-full text-foreground  space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:s.jsx(ne,{context:e})})}export{i as A,se as P,re as S,ie as a,de as b,b as c};
